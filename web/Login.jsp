...
<b> ${error}</b>
<div class="login">
    <form action="/superUser/login" method="post">
        <input type="text" name="userLoginName" value="admin"   placeholder="请输入昵称"/><br>
        <input type="password" name="userPassword"  value="12345"   placeholder="请输入密码"/><br>
        <div class="post">
